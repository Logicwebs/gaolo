...
{!! HTML::script('resources/assets/frontend/js/jquery.cycle.min.js') !!}
{!! HTML::script('resources/assets/frontend/js//jquery.backstretch.min.js') !!}
{!! HTML::script('resources/assets/frontend/js/jquery.validate.js') !!}
{!! HTML::script('resources/assets/frontend/js/scripts.js') !!}
