...
<?php echo HTML::script('resources/assets/frontend/js/jquery.cycle.min.js'); ?>

<?php echo HTML::script('resources/assets/frontend/js//jquery.backstretch.min.js'); ?>

<?php echo HTML::script('resources/assets/frontend/js/jquery.validate.js'); ?>

<?php echo HTML::script('resources/assets/frontend/js/scripts.js'); ?>
